...
{       
    ...
    while(true)
    {
        ...
        cout << previous_image.image_pts.size() << endl;
        // remove err point
        ...
        cv::String info = cv::format("Inliers: %d  XYZ: [%.3f, %.3f, %.3f]",inlier_num, _cam_pose_.at<double>(0, 0),_cam_pose_.at<double>(0, 1),_cam_pose_.at<double>(0, 2));
