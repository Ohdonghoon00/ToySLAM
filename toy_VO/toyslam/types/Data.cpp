...
std::string Read_Kitti_image_Data(char **kitti_data_num)
{
    ...
    std::string input_image_path ("/media/donghoon/1462-5978/kitti/sequences/");
...
double* Read_Kitti_Calibration_Data(char **kitti_calibration_data_num, double intrinsic_[])
{
    ...
    std::string cam_calib_path ("/media/donghoon/1462-5978/kitti/sequences/");
...
std::ifstream Read_Kiiti_GT_Data(char **kitti_gt_data_num)
{
    ...
    std::string GT_data_path ("/media/donghoon/1462-5978/kitti/poses/");
