...
std::cout << " new feature num  : " << previous_image.pts.size() << endl;   
            ...
            TrackOpticalFlowAndRemoveErrForTriangulate(previous_image.frame, current_image.frame, previous_image.pts, current_image.pts, keyframe_track_point);
...
std::cout << " map_point size before remove outlier : " <<  map_point.size() << endl;
                RemoveMPOutlier(map_point,  current_image.pts, clone_cam_pose_initialize);
...
std::cout << "before_track_feature_num  : " << before_track_feature_num << endl;
            ...
            track_opticalflow_and_remove_err_for_SolvePnP_(previous_image.frame, current_image.frame, previous_image.pts, current_image.pts, previous_image.pts_id, map_point);
...
std::cout << previous_track_point_for_triangulate.size() << "   " << current_track_point_for_triangulate.size() << "    " << previous_track_point_for_triangulate_ID.size() << "   " << keyframe_track_point.size() << endl;
            TrackOpticalFlowAndRemoveErrForTriangulate(previous_image.frame, current_image.frame, previous_track_point_for_triangulate, current_track_point_for_triangulate, previous_track_point_for_triangulate_ID, keyframe_track_point);
std::cout << previous_track_point_for_triangulate.size() << "   " << current_track_point_for_triangulate.size() << "    " << previous_track_point_for_triangulate_ID.size() << "   " << keyframe_track_point.size() << endl;            
...
std::cout << " map point size this keyframe before remove outlier  : " << map_point.size() << endl;
                    ...
                    RemoveMPOutlier(map_point, current_track_point_for_triangulate, previous_track_point_for_triangulate_ID, cam_pose_);
