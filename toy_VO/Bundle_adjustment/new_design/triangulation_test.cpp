...
std::cout << "SolvePnP map_point num : " << "   " << map_point.size()<<" current_image.pts.size() : " << current_image.pts.size() << endl;
...
std::cout << vec6d_to_homogenous_campose(previous_image.cam_pose_) << endl;
std::cout << vec6d_to_homogenous_campose(current_image.cam_pose_) << endl;

            P0 = K * cam_storage_to_projection_matrix(previous_image.cam_pose_);
...
std::cout << "after track_feature num  : " << current_image.pts.size() << endl;
                ...
                std::cout << " keyframe stage projection matrix    " << endl;
